<?php
    ...
    class selectPage extends Field
    {
         use Resource;
       ...
       {
           return view('fields.selectPage.Form')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
       ...
       {
           return view('fields.selectPage.Detail')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
       ...
       {
           return view('fields.selectPage.Index')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
                   'value' => $this->displayCallback($data , $resourceRequest , $field) ,
