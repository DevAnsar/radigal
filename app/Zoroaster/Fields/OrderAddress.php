<?php
    ...
    class OrderAddress extends Field
    {
         use Resource;
       ...
       {
           return view('fields.OrderAddress.Form')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
       ...
       {
           return view('fields.OrderAddress.Detail')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
       ...
       {
           return view('fields.OrderAddress.Index')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
                   'value' => $this->displayCallback($data , $resourceRequest , $field) ,
