<?php
    ...
    class OrderProducts extends Field
    {
         use Resource;
       ...
       {
           return view('fields.OrderProducts.Form')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
       ...
       {
           return view('fields.OrderProducts.Detail')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
       ...
       {
           return view('fields.OrderProducts.Index')->with(
               [
                   'field' => $field ,
                   'data' => $data ,
                   'value' => $this->displayCallback($data , $resourceRequest , $field) ,
