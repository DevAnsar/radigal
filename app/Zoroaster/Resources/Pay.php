<?php
    ...
    class Pay extends ZoroasterResource
    {
         ...
         * @var string
         */
        public $singularLabel = 'روش پرداخت';
            ...
            return [
             ...
             new RowOneCol([
                 ...
                 new Panel('' , [
                     ...
                     Image::make('عکس','images')->hideFromIndex()->path(function()
                     {
                         return 'pay' . '/'  ;
                     })
                 ]),
