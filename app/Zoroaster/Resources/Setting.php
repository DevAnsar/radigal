<?php
    ...
    class Setting extends ZoroasterResource
    {
            ...
            return [
             ...
             new RowOneCol([
                 ...
                 new Panel('' , [
                     ...
                     Text::make('نام تنظیم','index')->rules('required'),
                     Text::make('مقدار تنظیم','value')->rules('required'),
                 ]),
