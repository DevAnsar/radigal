<?php
    ...
    class Column2footer extends ZoroasterResource
    {
         ...
         * @var Model
         */
        public static $model = 'App\Column2footer';
         ...
         * @var string
         */
        public $singularLabel = 'ستون دوم فوتر';
            ...
            return [
             ...
             new RowOneCol([
                 ...
                 new Panel('' , [
                     ...
                     Text::make('آدرس','url')->rules('required'),
                 ]),
