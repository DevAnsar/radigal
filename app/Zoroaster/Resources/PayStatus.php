<?php
    ...
    class PayStatus extends ZoroasterResource
    {
         ...
         * @var Model
         */
        public static $model = 'App\PayStatus';
         ...
         * @var string
         */
        public $singularLabel = 'گزینه ی پرداخت';
            ...
            return [
             ...
             new RowOneCol([
                 ...
                 new Panel('' , [
                     ...
                     Text::make('عنوان گزینه','title')->rules('required'),
                 ]),
