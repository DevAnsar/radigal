<?php
    ...
    class Send extends ZoroasterResource
    {
         ...
         * @var string
         */
        public $singularLabel = 'روش ارسال ';
            ...
            return [
             ...
             new RowOneCol([
                 ...
                 new Panel('' , [
                     ...
                     Text::make('نوع ارسال','title')->rules('required'),
                     Text::make('توضیح','body')->rules('required'),
                     Text::make('مبلغ','price')->rules('required'),
                     Image::make('عکس','img')
                         ->help(' (64px*64px)  ')
                         ->hideFromIndex()->path(function()
                     {
                         return 'send' ;
                     })->rules('required'),
                 ]),
